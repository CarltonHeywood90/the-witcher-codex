    ...
    <nav className="border-b border-zinc-900 bg-zinc-950/70 backdrop-blur-md sticky top-0 z-50 px-4 md:px-12 py-4">
      <div className="max-w-5xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-3 md:gap-6 text-xs md:text-sm font-medium">
          ...
          <Link href="/biography" className="hidden md:block text-zinc-400 hover:text-zinc-100 transition-colors">
            Bio
          </Link>
          <Link href="/bibliography" className="hidden md:block text-zinc-400 hover:text-zinc-100 transition-colors">
            Bibliography
          </Link>
          <Link 
            href="/blog" 
